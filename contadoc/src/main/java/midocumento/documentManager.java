...
public class documentManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLBuscandoC = new javax.swing.JLabel();
        ...
        jLBuscandoM = new javax.swing.JLabel();
        ...
        jLRNombre = new javax.swing.JLabel();
        jLRApellidoP = new javax.swing.JLabel();
        jLRApellidoM = new javax.swing.JLabel();
        jLRTelefono = new javax.swing.JLabel();
        jLRTelefono1 = new javax.swing.JLabel();
        jLRCorreo = new javax.swing.JLabel();
        ...
        jLayeredPane1.setLayer(jLBuscandoC, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane2.setLayer(jLBuscandoM, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLRNombre.setForeground(new java.awt.Color(255, 102, 0));
        jLRNombre.setText("* Revise el contenido");

        jLRApellidoP.setForeground(new java.awt.Color(255, 102, 0));
        jLRApellidoP.setText("* Revise el contenido");

        jLRApellidoM.setForeground(new java.awt.Color(255, 102, 0));
        jLRApellidoM.setText("* Revise el contenido");

        jLRTelefono.setForeground(new java.awt.Color(255, 102, 0));
        jLRTelefono.setText("* Revise el contenido");

        jLRTelefono1.setForeground(new java.awt.Color(0, 0, 255));
        jLRTelefono1.setText("*Obligatorios");

        jLRCorreo.setForeground(new java.awt.Color(255, 102, 0));
        jLRCorreo.setText("* Revise el contenido");
        ...
        jLayeredPane3.setLayer(jLRNombre, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(jLRApellidoP, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(jLRApellidoM, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(jLRTelefono, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(jLRTelefono1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jLayeredPane3.setLayer(jLRCorreo, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane3Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane3Layout.createSequentialGroup()
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jLayeredPane3Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLRTelefono1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                ...
                .addGap(35, 35, 35)
                .addGroup(jLayeredPane3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLRApellidoP, javax.swing.GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
                    .addComponent(jLRApellidoM, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLRTelefono, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLRNombre, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLRCorreo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jBBuscarMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscarMActionPerformed
        ...
        modelo.clear();
        modeloDoc.clear();
        jLBuscandoM.setVisible(true);
        jBAgregar.setEnabled(false);
        jBQuitar.setEnabled(false);
        jLBuscandoC.setVisible(false);
        jLBuscandoM.setVisible(false);
    ...
    public void ocultarCampos() {
        ...
        jTFTipo.setVisible(false);
        jTFUbicacion.setVisible(false);
        jLRNombre.setVisible(false);
        jLRApellidoP.setVisible(false);
        jLRApellidoM.setVisible(false);
        jLRTelefono.setVisible(false);
        jLRCorreo.setVisible(false);
    }
    ...
    private void presentarResultadosB(ResultSet rs) {
        ...
        try {
            ...
            if(i==0) 
                jTAResultados.setText("Sin resultados");
        } catch (SQLException sqle) {
            // solo depuracion
            System.out.println("Instrucción incorrecta:" + sqle.getErrorCode() + " " + sqle.getMessage());
        }
    ...
    private void presentarResultadosD(ResultSet rs) {
        ...
        try {
            ...
            if(i==0) modelo.addElement("Sin resultados");
        } catch (SQLException sqle) {
            // solo depuracion
            System.out.println("Instrucción incorrecta:" + sqle.getErrorCode() + " " + sqle.getMessage());
        }
    ...
    private boolean hayNumeros(String cadena) {
    ...
    private boolean hayLetras(String cadena) {
        char[] ch = cadena.toCharArray();
        for (int i = 0; i < cadena.length(); i++) {
            if (!Character.isDigit(ch[i])) {
                jLRTelefono.setText("Verifique el número, ¡Carácter detectado!");
                jLRTelefono.setVisible(true);
                return true;
            }
        }
        return false;
    ...
    private boolean estaVacio() {
        if (jTFNombreNC.getText().isEmpty() || jTFApellidoPNC.getText().isEmpty()
        || jTFApellidoMNC.getText().isEmpty()) {
            
            if (jTFNombreNC.getText().isEmpty()) {
                System.out.println("Nombre vacio");
                jLRNombre.setText("Nombre vacío");
                jLRNombre.setVisible(true);
            }
            
            if (jTFApellidoPNC.getText().isEmpty()) {
                jLRApellidoP.setText("Apellido paterno vacío");
                System.out.println("Apellido paterno vacio");
                jLRApellidoP.setVisible(true);
            }
            
            if (jTFApellidoMNC.getText().isEmpty()) {
                jLRApellidoM.setText("Apellido materno vacío");
                System.out.println("Apellido materno vacio");
                jLRApellidoM.setVisible(true);
            }
            if (jTFTelefonoNC.getText().isEmpty()) {
                jLRTelefono.setText("Telefono vacío");
                jLRTelefono.setVisible(true);
            }
            System.out.println("Esta vacio:false");
            return true;
        }
        System.out.println("Esta vacio:true");
        return false;
    }
    
    private boolean datosCorrectos() {
        boolean aux = true;
        jLRNombre.setText("aux:"+aux);
        if (!estaVacio()) {
            aux=true && aux;
        } else {
            aux = false;
        ...
        jLRNombre.setText("aux:"+aux);
            ...
            if (!hayNumeros(jTFNombreNC.getText())) {
                aux=true && aux;
            } else {
                jLRNombre.setVisible(true);            
                aux = false;
            ...
            jLRNombre.setText("aux:"+aux);
            if (!hayNumeros(jTFApellidoPNC.getText())) {
                aux=true && aux;
            } else {
                jLRApellidoP.setText("Hay números en el apellido");
                jLRApellidoP.setVisible(true);
                aux = false;
            }
            jLRNombre.setText("aux:"+aux);
            if (!hayNumeros(jTFApellidoMNC.getText())) {
                aux=true && aux;
            } else {
                jLRApellidoM.setText("Hay números en el apellido");
                jLRApellidoM.setVisible(true);
                aux = false;
            }
            jLRNombre.setText("aux:"+aux);
            if (!hayLetras(jTFTelefonoNC.getText())) {
                aux= true && aux;
            } else  aux = false;
            jLRNombre.setText("aux:"+aux);
            if (jTFCorreoNC.getText().isEmpty() && aux == true) {
                jTFCorreoNC.setText("_");
                aux= true && aux;
        } else {
            if (esCorreo(jTFCorreoNC.getText())) {
                aux = true && aux;
            } else {
                jLRCorreo.setText("Revise el correo ingresado");
                jLRCorreo.setVisible(true);
                aux = false;
            }
        }
            jLRNombre.setText("aux:"+aux);
            if (jTFAsesorANC.getText().isEmpty() && aux==true) {
            jTFAsesorANC.setText("_");
        }
        return aux;
    }
    ...
    private void LlenarCamposDepu() {
        ...
        jTFAsesorANC.setText("Incorporacion fiscal");
    ...
    private javax.swing.JLabel jLBuscandoC;
    private javax.swing.JLabel jLBuscandoM;
    ...
    private javax.swing.JLabel jLRApellidoM;
    private javax.swing.JLabel jLRApellidoP;
    private javax.swing.JLabel jLRCorreo;
    private javax.swing.JLabel jLRNombre;
    private javax.swing.JLabel jLRTelefono;
    private javax.swing.JLabel jLRTelefono1;
